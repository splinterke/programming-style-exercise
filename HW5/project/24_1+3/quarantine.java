...
public class quarantine {
	...
	public static void main(String[] args){
	    ...
	    TFTheOne monad = new TFTheOne(userinput(args));
	    ReadFile _r_f = new ReadFile();
	    StopWord _s_w = new StopWord();
	    FrequencyCounter _f_c = new FrequencyCounter();
	    
	    monad.bind(_r_f).bind(_s_w).bind(_f_c);
	    monad.run();
	}
	
	//put the IO part in a separate method
...
class TFTheOne {
	...
	public List<dosomething> band = new ArrayList<dosomething>();
...
class ReadFile extends dosomething {
	...
	//put the IO part in a separate method
	public String[] readfile(String[] info) {
	    String path = info[0];
		String content = "";
	    String[] token = null;  
...
class StopWord extends dosomething {
	...
	public String[] act(String[] info){
		return stopword(info);
	}
	
	//put the IO part in a separate method
	public String[] stopword(String[] info) {
	    String content_sl = "";
...
class FrequencyCounter extends dosomething {
	...
	public String[] act(String[] info){
		...
		return printme(toPrint);
	}
	
	//put the IO part in a separate method
	public String[] printme (String[] value){
